...
<div class="px-4 py-4 pb-24 space-y-4">
    ...
    <div class="bg-white border border-gray-100 shadow-sm p-4 rounded-2xl">
        <h3 class="text-base font-bold text-gray-800 mb-2">Riwayat Pelanggaran</h3>
        <p class="text-xs text-gray-500">Daftar catatan sanksi atau kedisiplinan Anda akan muncul di sini.</p>
        
        {{-- Konten looping pelanggaran Anda di sini nanti --}}
    </div>
</div>
@endsection