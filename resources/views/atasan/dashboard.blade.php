                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors duration-150">
                        ...
                        <td class="px-8 py-4 text-center font-bold">
                            @if($index == 0)
                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-yellow-400 text-white text-xs font-bold">
                                1
                            </span>
                            @elseif($index == 1)
                            ...
                            @elseif($index == 2)
                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-amber-600 text-white text-xs font-bold">
                                3
                            </span>
                            @else
