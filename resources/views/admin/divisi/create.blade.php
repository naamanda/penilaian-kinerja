...
<div class="px-4">
    <div class="max-w-xl mx-auto mt-0">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 pt-4">
                <form action="/data-divisi/tambah" method="POST" class="space-y-3" autocomplete="off">
                    @csrf

                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase mb-1 ml-1 tracking-widest">Nama Divisi</label>
                        <input type="text" name="nama_divisi" value="{{ old('nama_divisi') }}" required placeholder="Masukkan nama divisi"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="tempat_kerja" required
                                ...
                                <option value="kantor" {{ old('tempat_kerja') == 'kantor' ? 'selected' : '' }}>Kantor</option>
                                <option value="lapangan" {{ old('tempat_kerja') == 'lapangan' ? 'selected' : '' }}>Lapangan</option>
                                <option value="lab" {{ old('tempat_kerja') == 'lab' ? 'selected' : '' }}>Lab</option>
                            </select>
